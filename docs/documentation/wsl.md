...
* Run the `winver` command and press **OK** or **Enter**:
  ...
  winver
  ```
* You'll get *About Windows* information saying Microsoft Windows or Windows Server version. If *OS Build* is `19041` or higher on Windows 10 or `1709` or higher on Windows Server 2019, continue. If not, please, check the [troubleshooting](#troubleshooting) section.
