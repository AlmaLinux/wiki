...
- Download the latest `.wsl` file for x86_64_v2 from [github.com/AlmaLinux/wsl-images/releases](https://github.com/AlmaLinux/wsl-images/releases) (e.g. `AlmaLinux-10.1_x64_v2_<version>.wsl`).
