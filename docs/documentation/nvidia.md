...
This will enable the AlmaLinux NVIDIA driver repository, CRB repository, and NVIDIA's upstream CUDA repository.  It will also install the [EPEL repository](https://docs.fedoraproject.org/en-US/epel/).

`sudo dnf install nvidia-openkmod`

This will install the GPU driver.
