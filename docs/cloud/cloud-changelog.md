...
### AlmaLinux OS versions **9.5-20250205** and AlmaLinux OS versions **8.10-20250215**

* Enhancements:
  * Updated the iSCSI optimizations accordingly the [OCI documentation](https://docs.oracle.com/en-us/iaas/Content/Block/Concepts/iscsiinformation.htm#iscsid).
...
Use `ttyAMA0` as a serial port on AArch64 accordingly the [OCI
documentation](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/enablingserialconsoleaccess.htm).
