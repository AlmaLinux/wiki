...
1. Make sure that you have enough free space: 500GB per major-version is the suggested minimum.  As there are currently two support major versions (8 and 9) the recommended minimum storage space is 1TB.
