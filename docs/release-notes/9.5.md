...
```bash
$ wget https://repo.almalinux.org/almalinux/9.5/isos/x86_64/CHECKSUM
...
```bash
$ rpm -i https://repo.almalinux.org/almalinux/9.5/BaseOS/x86_64/os/Packages/almalinux-repos-9.5-1.el9.x86_64.rpm --replacefiles
$ dnf upgrade -y
```
