...
$ wget https://vault.almalinux.org/8.3-beta/isos/x86_64/CHECKSUM
...
$ wget https://vault.almalinux.org/8.3-beta/isos/x86_64/AlmaLinux-8.3-beta-1-x86_64-boot.iso
...
will need to provide this `https://vault.almalinux.org/8.3-beta/BaseOS/x86_64/kickstart/`
...
`https://vault.almalinux.org/8.3-beta/AppStream/x86_64/os/`.
