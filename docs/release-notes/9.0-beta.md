...
- AlmaLinux 9 packages and repos are signed with the new [RPM-GPG-KEY-AlmaLinux-9](https://repo.almalinux.org/almalinux/RPM-GPG-KEY-AlmaLinux-9)
...
```bash
$ wget https://vault.almalinux.org/9.0-beta/isos/x86_64/AlmaLinux-9.0-beta-1-x86_64-boot.iso
```
...
```bash
$ wget https://vault.almalinux.org/9.0-beta/isos/x86_64/CHECKSUM
