...
You can reference the upstream [RHEL 9.2 Beta release notes](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9-beta/html/9.2_release_notes/index) for a full list of changes in this release.
