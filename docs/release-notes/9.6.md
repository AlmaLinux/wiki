...
```bash
$ wget https://vault.almalinux.org/9.6/isos/x86_64/AlmaLinux-9.6-x86_64-boot.iso
```
...
```bash
$ rpm -i https://vault.almalinux.org/9.6/BaseOS/x86_64/os/Packages/almalinux-repos-9.6-1.el9.x86_64.rpm --replacefiles
$ dnf upgrade -y
```
