...
* Re-enabled frame pointers by default. This enables system-wide real-time tracing and profiling for optimizing the performance of any workload running on AlmaLinux OS.
...
```bash
$ rpm -i https://repo.almalinux.org/almalinux/10.0/BaseOS/x86_64/os/Packages/almalinux-repos-10.0-30.el10.x86_64.rpm --replacefiles
$ dnf upgrade -y
```
