...
```bash
$ wget https://vault.almalinux.org/10.1-beta/isos/x86_64/AlmaLinux-10.1-beta-1-x86_64-boot.iso
```
...
```bash
$ wget https://vault.almalinux.org/10.1-beta/isos/x86_64/CHECKSUM
