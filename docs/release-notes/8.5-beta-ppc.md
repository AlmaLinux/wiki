...
```bash
$ wget https://vault.almalinux.org/8.5-beta/isos/ppc64le/AlmaLinux-8.5-beta-1-ppc64le-boot.iso
```
...
```bash
$ wget https://vault.almalinux.org/8.5-beta/isos/ppc64le/CHECKSUM
