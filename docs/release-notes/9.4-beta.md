...
As we aim to match release versions and cadences with Red Hat Enterprise Linux, you can reference the [RHEL 9.4 release notes](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9-beta/html/9.4_release_notes/overview) for a full list of changes in this release.

## Upgrade Instructions

**Please do not use these update instructions on production machines unless you don't mind if something breaks** ;)

Upgrade the almalinux-release packages to the 9.4-.el9 version from the beta repositories:
