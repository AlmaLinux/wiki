...
- AlmaLinux 9 packages and repositories are signed with the new [RPM-GPG-KEY-AlmaLinux-9](https://repo.almalinux.org/almalinux/RPM-GPG-KEY-AlmaLinux-9) GPG key
...
```bash
$ wget https://vault.almalinux.org/9.0/isos/x86_64/CHECKSUM
