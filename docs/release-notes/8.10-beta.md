...
```bash
$ wget https://vault.almalinux.org/8.10-beta/isos/x86_64/AlmaLinux-8.10-beta-1-x86_64-boot.iso
```
...
```bash
$ wget https://vault.almalinux.org/8.10-beta/isos/x86_64/CHECKSUM
