...
As we aim to match release versions and cadences with Red Hat Enterprise Linux, you can reference the [RHEL 8.10 Beta release notes](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8-beta/html/8.10_release_notes/index) for a full list of changes in this release.
