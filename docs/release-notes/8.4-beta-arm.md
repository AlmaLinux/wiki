...
```bash
$ wget https://vault.almalinux.org/8.4-beta/isos/aarch64/AlmaLinux-8.4-beta-1-aarch64-boot.iso
```
...
```bash
$ wget https://vault.almalinux.org/8.4-beta/isos/aarch64/CHECKSUM
