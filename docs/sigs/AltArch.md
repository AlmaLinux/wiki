...
The AltArch SIG uses [AltArch](https://chat.almalinux.org/almalinux/channels/sigaltarch) chat channel for communication.

**Where and when we meet**

Meetings will be held bi-weekly, with timing adjusted to accommodate members across different time zones. We also work asynchronously in Mattermost to accomplish our goals between meetings.
