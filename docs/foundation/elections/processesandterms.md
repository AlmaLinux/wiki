...
All Foundation members in good standing as of the voter eligibility cutoff date (announced with each election) are eligible to vote. Voting weights by membership type are defined in the bylaws and reflected in the [Membership Levels and Benefits](https://wiki.almalinux.org/foundation/memberbenefits.html).
...
If you have questions about an election, the best place to ask is in the `~foundation` channel on [chat.almalinux.org](https://chat.almalinux.org), or by emailing elections@almalinux.org.
